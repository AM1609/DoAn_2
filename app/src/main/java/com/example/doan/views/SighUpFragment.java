...
public class SighUpFragment extends Fragment {
    ...
    private EditText editEmail, editPass, editPassUpAgain;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sigh_up, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        signInText = view.findViewById(R.id.textSignUp);
        signUpBtn = view.findViewById(R.id.btnSignUp);
        editPassUpAgain = view.findViewById(R.id.editPassUpAgain);
        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String passAgain = editPassUpAgain.getText().toString();
                if (!email.isEmpty() && !pass.isEmpty()&& !passAgain.isEmpty()) {
                    if (pass.equals(passAgain)) {
                        ...
                        Toast.makeText(getContext(), "Mật khẩu và Nhập Lại Mật khẩu phải giống nhau", Toast.LENGTH_SHORT).show();
                    }
                } else {
